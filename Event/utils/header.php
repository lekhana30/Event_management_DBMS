    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1 style="font-family:verdana;"><font color="LightCyan">BIGHIT EVENTS</font></h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
 <p1 style="font-family:verdana;"><font color="LightCyan"><font size =5>Whether you're looking to book a cocktail party, post-work gathering, celebratory function, conference, business meeting, wedding or private dining event, our dedicated Urban Events team can create a package that will meet
                your every need.</font></font></p1>
                </p>
