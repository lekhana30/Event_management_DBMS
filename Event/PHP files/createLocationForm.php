        ...
        <div class="content">
            <div class="container">
                ...
                <form action="createLocation.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="managerFName" class="col-md-2 control-label">First Name</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="managerLName" class="col-md-2 control-label">Last Name</label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label for="managerEmail" class="col-md-2 control-label">Manager Name</label>
                        <div class="col-md-5">
